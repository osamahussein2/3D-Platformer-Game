...
House::House(glm::vec3 position_, glm::vec3 size_) : position(position_), size(size_)
{
}
...
void House::InitializeMainMenuObject()
{
	cubeVertices =
	{
		// back face
...
void House::InitializeMainMenuObjectTextures(const char* file_)
{
