...
GameGround::GameGround(glm::vec3 position_, glm::vec3 size_) : position(position_), size(size_)
{
}
...
void GameGround::InitializeGameObject()
{
	cubeVertices =
	{
		// back face
...
void GameGround::InitializeGameObjectTextures(const char* file_)
{
...
void GameGround::DrawGameObject()
{
